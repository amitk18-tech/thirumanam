...
<body onload="print_details();">
    <?php 
    $arrays = array($single_member);
    // $sort = sort($array);
     $memebr_ids_decode = explode(',',$single_member);

asort($memebr_ids_decode);
// print_r($memebr_ids_decode);exit;
foreach($memebr_ids_decode as $member)
{
    $single_member = get_allmembers($member);
...
<div class="bs-docs-example" id="printableArea">
   <div class="watermark"></div>
        ...
        <div style="width: 100%;float: left;font-size:14px;line-height: 18px;">
            <p style="margin-bottom:6px"><?php echo translate('pdfNote1');?></p>
            <p style="margin-bottom:6px"><?php echo translate('pdfNote2')?></p>
            <p style="margin-bottom:6px"> <?php echo translate('pdfNote3')?></p>
            <p style="margin-bottom:6px"><?php echo translate('pdfNote4')?></p>
            <p style="margin-bottom:6px"><?php echo translate('pdfNote5')?></p>
            <p style="margin-bottom:6px"><?php echo translate('pdfNote6')?></p>
            <p style="margin-bottom:6px"><?php echo translate('pdfNote7')?></p>
            <p style="margin-bottom:6px"><?php echo translate('pdfNote8')?></p>
            <p style="margin-bottom:6px"><?php echo translate('pdfNote9')?></p>
        </div>
        <table class="table1" style="width:100%">
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:center;" colspan="2"><p style="margin-bottom: 5px;"><?php echo translate('VENUE_SPONSOR');?>:</p><h2><b><?php echo translate('heading12');?></b></h2></td>
                </tr>
                <tr>
