...
<body>
    <?php 
    $data=getData('general_settings','row',array('type'=>'forget_pass_image'));
    $images = json_decode($data->value);
    foreach($images as $image){

    }
    $img = base_url('uploads/forget_pass_image/'.$image->image);

    // print_r($img);exit;
    ?>
    <div class="auth-page-wrapper pt-5"  style="background-image: url(<?php echo $img;?>);background-position: center;background-size: cover; height: 46em;" >
        <!-- auth page bg -->
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card mt-3">
                            <form action="<?php echo base_url('LoginController/forgetEmail'); ?>" method="post">
                                <div class="card-body p-4">
                                    ...
                                    <div class="p-2 mt-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="username" name="email" autofocus="" placeholder="Enter Email" required>
                                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                <script>document.write(new Date().getFullYear())</script> <?php echo strtoupper(getSettings()->site_title); ?>. Crafted with <i class="mdi mdi-heart text-danger"></i> by <a target="_blank" href="http://iclient.tech/">iCLIENTTECH</a>
                            </p>
                        </div>
                    </div>
                </div>
