        ...
        <div class="card" style="position: absolute;">
            ...
            <div class="btn-group">
                <button class="btn btn-primary btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <?=translate('online_unpaid_incomplete_profile')?>
                </button>
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="<?php echo base_url('administrator/incomplete_profile/')?>"><?=translate('all_member')?></a>
                    <a class="dropdown-item" href="<?php echo base_url('administrator/incomplete_profile/online_paid')?>"><?=translate('online_paid_incomplete_profile')?></a>
                    <a class="dropdown-item" href="<?php echo base_url('administrator/incomplete_profile/online_unpaid')?>"><?=translate('online_unpaid_incomplete_profile')?></a>
                    <a class="dropdown-item" href="<?php echo base_url('administrator/incomplete_profile/offline')?>"><?=translate('offline_incomplete_profile')?></a>
                </div>
            </div>
                ...
                <table id="datatable" class="display table table-bordered dt-responsive" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo translate('followers')?></th>
...
//         ajax: base_url+"AjaxController/incompleteOnlineUnpaid",
...
// alert(base_url); 
      var dataTable = $('#datatable').DataTable( {
        ...
        "pagingType": "input",
        "ajax":{
          url :base_url+"administrator/incompleteOnlineUnPaidMembers", // json datasource
          type: "POST",
