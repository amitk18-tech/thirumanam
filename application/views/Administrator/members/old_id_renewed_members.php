        ...
        <div class="card" style="position: absolute;">
            ...
            <!-- <div class="btn-group">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="<?php echo base_url('administrator/close_members')?>">All Members</a>
                    <a class="dropdown-item" href="<?php echo base_url('administrator/close_members/offline')?>">Offline Registered Members</a>
                    <a class="dropdown-item" href="<?php echo base_url('administrator/close_members/online')?>">Online Registered Members</a>
                </div>
            </div> -->
...
//         ajax: base_url+"AjaxController/oldIdMembers",
...
// alert(base_url); 
      var dataTable = $('#datatable').DataTable( {
        ...
        "pagingType": "input",
        "ajax":{
          url :base_url+"administrator/oldRenewedMember", // json datasource
          type: "POST",
