        ...
        <div class="card" style="position: absolute;">
            ...
            <div class="btn-group">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="<?php echo base_url('administrator/matched_members')?>"><?=translate('all_member')?></a>
                    <a class="dropdown-item" href="<?php echo base_url('administrator/matched_members/male')?>"><?=translate('male')?></a>
                    <a class="dropdown-item" href="<?php echo base_url('administrator/matched_members/female')?>"><?=translate('female')?></a>
                </div>
            </div>
            ...
            <div class="card-body" style="margin-bottom: 50px;">
                <table id="all_customers" class="display table table-bordered dt-responsive">
                    <thead>
...
// alert(base_url); 
      var dataTable = $('#all_customers').DataTable( {
        ...
        "pagingType": "input",
        "ajax":{
          url :base_url+"administrator/matchedMember", // json datasource
          type: "POST",
...
//         ajax: base_url+"AjaxController/listMembers",
