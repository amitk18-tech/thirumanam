                ...
                <table id="datatable" class="display table table-bordered dt-responsive" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo translate('report_details')?></th>
                            <th><?php echo translate('profile_downloads')?></th>
                            <th><?php echo translate('date')?></th>
                            <th><?php echo translate('reported_by')?></th>
...
//         ajax: base_url+"AjaxController/reportedMembers",
...
// alert(base_url); 
      var dataTable = $('#datatable').DataTable( {
        ...
        "pagingType": "input",
        "ajax":{
          url :base_url+"administrator/reportProfileMember", // json datasource
          type: "POST",
