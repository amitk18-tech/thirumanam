        ...
        <div class="card" style="position: absolute;">
            ...
            <div class="btn-group">
                <button class="btn btn-primary btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <?=translate('OnlineUnpaidMembers')?>
                </button>
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="<?php echo base_url('administrator/online_members')?>"><?=translate('all_member')?></a>
                    <a class="dropdown-item" href="<?php echo base_url('administrator/online_members/male')?>"><?=translate('male')?></a>
                    <a class="dropdown-item" href="<?php echo base_url('administrator/online_members/female')?>"><?=translate('female')?></a>
                    <a class="dropdown-item" href="<?php echo base_url('administrator/online_members/renew')?>"><?=translate('active_members')?></a>
                    <a class="dropdown-item" href="<?php echo base_url('administrator/online_members/unpaid')?>"><?=translate('OnlineUnpaidMembers')?></a>
                </div>
            </div>
...
// alert(base_url); 
      var dataTable = $('#datatable').DataTable( {
        ...
        "pagingType": "input",
        "ajax":{
          url :base_url+"administrator/pendingRenewalUnpaidMembers", // json datasource
          type: "POST",
...
//         ajax: base_url+"AjaxController/onlineRegisterUnpaid",
