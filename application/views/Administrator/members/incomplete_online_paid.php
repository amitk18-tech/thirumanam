        ...
        <div class="card" style="position: absolute;">
            ...
            <div class="btn-group">
                <button class="btn btn-primary btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <?=translate('online_paid_incomplete_profile')?>
                </button>
...
//         ajax: base_url+"AjaxController/incompleteOnlinePaid",
...
// alert(base_url); 
      var dataTable = $('#datatable').DataTable( {
        ...
        "pagingType": "input",
        "ajax":{
          url :base_url+"administrator/incompleteOnlinePaidMembers", // json datasource
          type: "POST",
