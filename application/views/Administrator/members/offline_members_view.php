    ...
    <div class="col-lg-12">
        <div class="card" style="position: absolute;">
            ...
            <div class="card-body" style="margin-bottom: 50px;">
                <table id="offline_customers" class="display table table-bordered dt-responsive" style="width:100%">
                    <thead>
                        <tr>
...
// alert(base_url); 
      var dataTable = $('#offline_customers').DataTable( {
        ...
        "pagingType": "input",
        "ajax":{
          url :base_url+"administrator/offline_customer_server_table", // json datasource
          type: "post",
...
//         ajax: base_url+"AjaxController/offlineMembers",
