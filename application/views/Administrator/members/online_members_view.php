    ...
    <div class="col-lg-12">
        <div class="card" style="position: absolute;">
            ...
            <div class="card-body" style="margin-bottom: 50px;">
                <table id="online_customers" class="display table table-bordered dt-responsive" style="width:100%">
                    <thead>
                        <tr>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    new DataTable("#datatable", {        
        ajax: base_url+"AjaxController/onlineMembers",
...
var base_url=$('#base_url').val(); 
// alert(base_url); 
      var dataTable = $('#online_customers').DataTable( {
        ...
        "pagingType": "input",
        "ajax":{
          url :base_url+"administrator/online_customer_server_table", // json datasource
          type: "post",
