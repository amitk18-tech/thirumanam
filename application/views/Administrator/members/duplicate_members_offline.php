        ...
        <div class="card" style="position: absolute;">
            ...
            <div class="btn-group">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="<?php echo base_url('administrator/duplicate_members')?>"><?=translate('all_member')?></a>
                    <a class="dropdown-item" href="<?php echo base_url('administrator/duplicate_members/offline')?>"><?=translate('offline_member')?></a>
                    <a class="dropdown-item" href="<?php echo base_url('administrator/duplicate_members/online')?>"><?=translate('OnlineRegisteredMembers')?></a>
                </div>
            </div>
...
//         ajax: base_url+"AjaxController/duplicateOffline",
...
// alert(base_url); 
      var dataTable = $('#datatable').DataTable( {
        ...
        "pagingType": "input",
        "ajax":{
          url :base_url+"administrator/duplicatedOfflineMembers", // json datasource
          type: "POST",
