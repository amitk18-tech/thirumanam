        ...
        <div class="card"  style="position: absolute;">
            ...
            <div class="btn-group">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="<?php echo base_url('administrator/block_members')?>"><?=translate('all_member')?></a>
                    <a class="dropdown-item" href="<?php echo base_url('administrator/block_members/offline')?>"><?=translate('offline_member')?></a>
                    <a class="dropdown-item" href="<?php echo base_url('administrator/block_members/online')?>"><?=translate('OnlineRegisteredMembers')?></a>
                </div>
            </div>
                ...
                <table id="datatable" class="display table table-bordered dt-responsive" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo translate('block_reason')?></th>
...
// alert(base_url); 
      var dataTable = $('#datatable').DataTable( {
        ...
        "pagingType": "input",
        "ajax":{
          url :base_url+"administrator/blockedOfflineMembers", // json datasource
          type: "POST",
...
//         ajax: base_url+"AjaxController/blockMembersOffline",
