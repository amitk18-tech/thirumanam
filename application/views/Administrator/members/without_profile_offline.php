        ...
        <div class="card" style="position: absolute;">
            ...
            <div class="btn-group">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="<?php echo base_url('administrator/without_profile/')?>"><?=translate('all_member')?></a>
                    <a class="dropdown-item" href="<?php echo base_url('administrator/without_profile/offline')?>"><?=translate('offline_member')?></a>
                    <a class="dropdown-item" href="<?php echo base_url('administrator/without_profile/online')?>"><?=translate('OnlineRegisteredMembers')?></a>
                </div>
            </div>
...
// alert(base_url); 
      var dataTable = $('#datatable').DataTable( {
        ...
        "pagingType": "input",
        "ajax":{
          url :base_url+"administrator/withoutProfileOfflineMembers", // json datasource
          type: "POST",
...
//         ajax: base_url+"AjaxController/withoutProfileOffline",
