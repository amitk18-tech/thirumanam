    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <a class="float-end btn btn-sm btn-outline-primary btn-border" href="<?php echo base_url('administrator/add_staff'); ?>"><?= translate('create_new')?></a>
            </div>
            <div class="card-body">
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    new DataTable("#datatable", {        
        ajax: base_url+"AjaxController/allStaffs",
