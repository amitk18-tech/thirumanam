        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="live-preview">
                    <form action="<?php echo base_url('AdminController/saveRole/');?>" method="post">
                    <div class="row gy-4">
                        ...
                        <div class="col-xxl-3 col-md-6">
                            <div>
                                ...
                                <textarea type="text" class="form-control" id="basiInput" name="description"></textarea>
                            </div>
                        </div>
                        <!--end col-->
                        <div class="col-xxl-3 col-md-6">
                            <div>
                                ...
                                <select class="form-control" id="choices-multiple-remove-button" data-choices data-choices-removeItem name="permission[]" multiple>
                                    ...
                                    <option value="<?php echo $permission->permission_id;?>"><?php echo $permission->codename;?></option> 
                                    <?php } } ?>
                                </select>
                            </div>
                        </div>
