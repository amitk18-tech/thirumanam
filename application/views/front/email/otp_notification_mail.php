 ...
 <div class="main_cover" style="margin: 0 auto;width: 100%;">
  ...
  <div class="mail_header" style="float: left;width: 100%; background-color: #e3e3e3;">
  	<div class="logo_image" style="float: left;">
  		<img src="<?php echo base_url(); ?>vallikodi/assets/img/logo1.png" class="sitelogo">
  ...
  <div class="mail_body" style="float: left;width: 100%;margin: 6px 0 0;min-height: 200px;">
  	...
  	<h5>One Time Password Notification Mail</h5>
	  <!--<p>Your Login One Time Password was send in your mobile Number</p>-->
    <p><b><?php echo $otp;?></b> is your OTP to login to your Vallikodi Matrimony Account</p>
  </div><!-- mail body div -->
