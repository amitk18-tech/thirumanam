...
$Type_of_study='';
 ...
 ?>
    ...
    <div class="group__bottom--area mt-4">
            ...
            <?php } ?></a>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-2 mt-2">
                                        <a style="width:100%;font-size:10px;" target="_blank" href="<?php echo base_url('short_view/'.$value->member_id);?>" class="btn btn-xs btn-sm btn-outline-success btn-border mr-1"><?php echo translate('full_profile')?></a>
                                    </div>
