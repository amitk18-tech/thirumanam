...
<div class="pageheader bg_img" style="background-image: url(<?php echo base_url('assets/front');?>/images/bg-img/pageheader.jpg);">
        <div class="container">
            <div class="pageheader__content text-center">
                <h2><?php echo translate('active_members ')?></h2>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center mb-0" style="background-color:transparent!important">
                      ...
                      <li class="breadcrumb-item active" aria-current="page"><?php echo translate('active_members')?></li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="col-lg-3">
                    <div class="group__bottom--right">
                        <div class="modal-content border-0 mb-4">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('active_member_list');?>" method="post">
                                    ...
                                    <div class="banner__list">
                                        <div class="row align-items-center row-cols-1">
                                            ...
                                            <div class="col">
                                                <label style="color:white;"><?php echo translate('star')?></label>
                                                <?php  
                                        ...
                                        <?php } ?>
                                            ...
                                            <div class="pt-0" style="display: none;">
                                                ...
                                                <div class="col">
                                                <button type="submit" class="btn btn-info d-block w-100"><?php echo translate('search')?></button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                        ...
                        <div class="group__bottom--body bg-white p-0">
                            ...
                            <?php } ?></a>
                                                ...
                                                <div class="activity__content" style="width: 80%;">
                                                    <h5><a href="<?php echo base_url('short_view/'.$value->member_id);?>"><?php echo $value->first_name;?> </a><span class="text-danger"><?php echo translate('Member ID')?>:
                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-md-2 mt-2">
                                                        <a style="width:100%;font-size:10px;" href="<?php echo base_url('short_view/'.$value->member_id);?>" class="btn btn-xs btn-sm btn-outline-success btn-border mr-1"><?php echo translate('full_profile')?></a>
                                                    </div>
