...
<div class="container">
          ...
          <div class="single-news-post d-flex align-items-center bg-gray mt-1">
            ...
            <div class="post-content">
             <div class="row">
                ...
                <div class="col-2">
                    <a onclick="deleteShortlist(<?php echo $member->member_id?>)" class="post-title text-center" style="font-weight: 700;border:1px solid #f8587e;border-radius: 20px;color:#f8587e;font-size: 17px!important;">x</a>
                </div>
             </div>  
          ...
          <div class="row p-2">
              <div class="col-6" style="width:100%;">
                   <a class="btn btn-success" style="padding: 7px;border-radius: 8px;background: white;color:#f8587e;box-shadow: 0 2px 2px 0 rgba(16, 13, 209, 0.175);border: none;font-size: 14px;padding-left: 40px;padding-right: 40px;margin-top: 2px" href="<?php echo base_url('app/short_view/'.$member->member_id);?>"><?php echo translate('more_info')?></a>
              </div>
              <?php 

                if($count_interest == 0){

                     echo '<a class="btn btn-success" style="border-radius: 8px;font-size: 14px;color:white;padding-left: 30px;padding-right: 30px;margin-top: 2px"  data-toggle="modal" data-target="#interestModal">'.translate('interest').'</a>';
                    }else{

                       echo '<a class="btn btn-success" style="border-radius: 8px;font-size: 14px;color:white;padding-left: 30px;padding-right: 30px;margin-top: 2px" onclick="doInterest('.$member->member_id.')">'.translate('interest').'</a>';
