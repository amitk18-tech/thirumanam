...
<div class="page-content-wrapper">
   <span style="position: relative;">
      <div  style=" position: absolute;text-align: end;color: white; background-color: #f8587e;right: 0;margin-right: 10px;margin-top: 20px!important;padding: 5px;">
   <a id="load_image_section" onclick="document.getElementById('profile_image').click();"><i style="font-size:20px;" class="fas fa-pencil-alt"></i></i></a>
               <span id="save_button_section" style="display:none;color: white;">
                  <a id="save_image" style="font-size: 20px;">save</a>
               </span>
   </div>
<?php if($getUser->gender==1){?>
   <img src="<?php echo (!empty($profile_image && $profile_image[0]['profile_image'])) ? base_url('uploads/profile_image/'.$profile_image[0]['profile_image']) : base_url('uploads/profile_image/default.jpg') ;?>" alt="member-img" id="pimage_preview" style="width: 100%;height: 15em;object-fit: cover;" onError="this.onerror=null;this.src='<?php echo base_url('uploads/profile_image/default.jpg') ?>';">
 <?php } ?>
 <?php if($getUser->gender==2){?>

   <img src="<?php echo (!empty($profile_image && $profile_image[0]['profile_image'])) ? base_url('uploads/profile_image/'.$profile_image[0]['profile_image']) : base_url('uploads/profile_image/default_female.jpg') ;?>" alt="member-img" id="pimage_preview" style="width: 100%;height: 15em;object-fit: cover;" onError="this.onerror=null;this.src='<?php echo base_url('uploads/profile_image/default_female.jpg') ?>';">
 <?php } ?>
   <!-- Profile Content Wrapper-->
</span>
   <div class="profile-content-wrapper" style="margin-right: 15px;margin-left: 15px;
    height: 122px;margin-top: -25px;padding-top: 10px;background: white!important;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);margin-bottom: 20px;">
      ...
      <div class="container">
         ...
         <div class="user-meta-data d-flex align-items-center">
            ...
            <div class="">
                   ...
                   <?php if($getUser->gender==1){?>
                     <img src="<?php echo (!empty($profile_image && $profile_image[0]['profile_image'])) ? base_url('uploads/profile_image/'.$profile_image[0]['profile_image']) : base_url('uploads/profile_image/default.jpg') ;?>" alt="member-img" id="pimage_preview" style="margin-bottom: 115px;border-radius: 10px;height: 100px!important;" onError="this.onerror=null;this.src='<?php echo base_url('uploads/profile_image/default.jpg') ?>';">
                   <?php } ?>
                   <?php if($getUser->gender==2){?>

                     <img src="<?php echo (!empty($profile_image && $profile_image[0]['profile_image'])) ? base_url('uploads/profile_image/'.$profile_image[0]['profile_image']) : base_url('uploads/profile_image/default_female.jpg') ;?>" alt="member-img" id="pimage_preview" style="margin-bottom: 115px;border-radius: 10px;height: 100px!important;" onError="this.onerror=null;this.src='<?php echo base_url('uploads/profile_image/default_female.jpg') ?>';">
                   <?php } ?>
            ...
            <div class="user-content" style="margin-bottom: 120px;">

               <h5  style="color:#020b10d4;margin-bottom: 0px;">
                  
               <?php echo $getUser->first_name?></h5>

               <h6 style="color:#020b10d4;margin-bottom: 0px;"><?php echo $getUser->member_profile_id;?></h6>
               <?php if(empty($pop_up))
               {?>
               <span style="color:#020b10d4;margin-bottom: 0px;font-size: 13px"><?php echo translate('subscribed_user');?></span>
            <?php }else
            {?>
               <span style="color:red;margin-bottom: 0px;font-size: 13px"><?php echo translate('not_subscribed_user');?></span>
            <?php } ?>
               <div class="user-meta-data d-flex align-items-center justify-content-between">
                  
                   <div>
                     <a href="<?php echo base_url('app/Subscription')?>" style="color:white"class="btn btn-sm btn-block btn-primary "><?php echo translate('plan');?></a>
                  </div>

            <a <?php if($getUser->updateProfileDoneStatus == 1 && $flag == 2){ echo "style='display:none'"; } 
              if($flag == 1){ ?> href="<?=base_url()?>app/Subscription" title="<?=translate('7_days_text')?>" <?php } ?>
           onclick="edit_all()" style="cursor: pointer;" class="btn btn-sm float-right btn-info rounded-pill text-white"> <?php echo translate('edit')?></a>
            <?php if($checkUpdateCompleteProfile == 1){ ?>
               <a <?php if($flag == 1){ echo "style='display:none'";  } ?>
           onclick="edit_all()" style="cursor: pointer;" class="btn btn-sm float-right btn-info rounded-pill text-white"> <?php echo translate('edit')?></a>
               <?php } ?> 
   ...
   <div class="profile-content-wrapper">
      ...
      <div class="container">
         ...
         <div class="user-meta-data align-items-center">

            

            <div class="user-content" style="max-width: 100%!important;
    width: 100%;">
               ...
               <div class="user-meta-data d-flex align-items-center justify-content-between">
                  <div class="row">
                     <div class="col-md-3 col-3">
                        <p class="mx-1"><span class="counter"><?php echo $getUser->remain_download?></span><span class="span"><?php echo translate('profile_download')?></span></p>
                     </div>
                     <div class="col-md-3 col-3">
               ...
               $payment= getMemberCurrentPayment($getUser->member_id);                
                ...
                <?php if($getUser->report_married_status==0) {?>
                  <button onclick="add_married(<?php echo $getUser->member_id;?>)" class="btn btn-xs btn-sm btn-outline-secondary btn-border mr-1 mt-3"><?php echo translate('mariage_fixed');?></button>
               <?php }else { ?>
...
<div class="page-content-wrapper" style="margin-bottom: 0px!important;">
   <div class="popular-tags-list">
      <div class="container">
         <div class="row">
            <div class="col-3 text-center">
               <a class="button btn-sm m-1" href="<?php echo base_url('app/matched_members');?>">
                  <i class="fas fa-users"></i>
                  
               </a>
            </div>
            <div class="col-3 text-center">
               <a class="button btn-sm m-1" href="<?php echo base_url('app/shortlist');?>">
                  <i class="fas fa-thumbs-up"></i>
                  
               </a>
            </div>
            <div class="col-3 text-center">
               <a class="button btn-sm m-1" href="<?php echo base_url('app/viewlist');?>">
                  <i class="far fa-user"></i>
                  
               </a>
            </div>
            <div class="col-3 text-center">
               <a class="button btn-sm m-1" href="<?php echo base_url('app/messaging');?>">
         ...
         <div class="row mt-2">
            <div class="col-3 text-center">
                  ...
                  <a style="font-size: 10px!important;" class="btn-sm" href="<?php echo base_url('app/matched_members');?>">
                  <?php echo  translate('matches');?></a>
              
            </div>
            <div class="col-3 text-center">
               
                  <a style="font-size: 10px!important;" class="btn-sm" href="<?php echo base_url('app/shortlist');?>">
                     <?php echo  translate('shortlisted_profile');?>
                  </a>
              
            </div>
            <div class="col-3 text-center">
              
                  <a style="font-size: 10px!important;" class="btn-sm" href="<?php echo base_url('app/viewlist');?>">
                     <?php echo  translate('views');?>
                  </a>
               
            </div>
            <div class="col-3 text-center">
              
                  <a style="font-size: 10px!important;" class="btn-sm" href="<?php echo base_url('app/messaging');?>">
      ...
      <div class="all-pages-wrapper">
        <div class="container">
          <ul class="page-nav">
            ...
            <li><a href="<?php echo base_url('app/opposite_interests');?>"><?php echo  translate('Interests_in_me');?><i class="lni lni-chevron-right"></i></a></li>
            ...
            <li><a href="<?php echo base_url('LoginController/app_do_logout');?>"><?php echo  translate('logout');?><i class="lni lni-chevron-right"></i></a></li>
      ...
      <div class="container">
         ...
         <div class="row mb-3">
            <div class="col-md-6 mb-1">
               <span><?php echo translate('member_id');?></span> <?php echo $getUser->member_profile_id; ?>
            </div>
            <div class="col-md-6 col-6 mb-1">
               <span><?php echo translate('registration_date');?></span> <?php echo date('d-m-Y',strtotime($getUser->member_since)); ?>
            </div>
         </div>
      <!-- </div> -->
         <div class="mb-3 d-flex align-items-center justify-content-between">
         ...
         <div class="card settings-card">
            ...
            <div class="card-body" id="info_permanent_address">
               ...
               <?php if(!empty($permanent_address_data[0]['permanent_state'])){
                  ...
                  <div class="title"><label style="color: #797494;margin-right: 10px"><?php echo translate('OTHERS');?></label><span> - <?php echo (!empty($permanent_address_data[0]['permanent_city_other'])) ? $permanent_address_data[0]['permanent_city_other'] : "";?></span></div>
               ...
               <?php }else{ ?>
                  ...
                  <div class="title"><label style="color: #797494;margin-right: 10px"><?php echo translate('mobile');?></label><span> - <?php echo (!empty($getUser->mobile)) ? $getUser->mobile : "";?></span></div>
         ...
         <div class="card settings-card">
            ...
            <div class="card-body" id="info_family_information">
               ...
               <?php } } ?>
                  ...
                  <div class="title"><label style="color: #797494;margin-right: 5px"><?php echo translate('Number_of_married_brothers');?></label><span> - <?php if(!empty($family_info_data[0]['Number_of_married_brothers'])){ 
                ...
                <div class="title"><label style="color: #797494;margin-right: 5px"><?php echo translate('Number_of_Sisters');?></label><span> - <?php if(!empty($family_info_data[0]['Number_of_Sisters'])){ 
                ...
                <div class="title"><label style="color: #797494;margin-right: 5px"><?php echo translate('Property_Description');?></label><span> - <?php echo (!empty($family_info_data[0]['Property_Description'])) ? dropdownTranslate($family_info_data[0]['Property_Description']) : "";?></span></div>
                ...
                <div class="title"><label style="color: #797494;margin-right: 5px"><?php echo translate('Other_Property_Description');?></label><span> - <?php echo (!empty($family_info_data[0]['Other_property_description'])) ? $family_info_data[0]['Other_property_description'] : "";?></span></div>
             <?php } } ?>
            ...
            <div class="card-body" id="info_partner_expectation">
             ...
             <?php }  if($partner_expectation_data[0]['partner_TYPE_OF_DOSHAM']=='OTHERS'){?>
               ...
               <?php } ?>
                ...
                <?php if($partner_expectation_data[0]['partner_Expectation']=='OTHERS'){?>
                <div class="title"><label style="color: #797494;margin-right: 10px"><?php echo translate('OTHERS');?></label><span> - <?php echo (!empty($partner_expectation_data[0]['partner_Other_Expectation'])) ? $partner_expectation_data[0]['partner_Other_Expectation'] : "";?></span></div>
   ...
   <div class="traffic-source-wrapper" style="padding-bottom: 80px;">
      ...
      <div class="container">
         ...
         <div class="card settings-card">
            ...
            <div class="card-body" id="info_chart" style="padding: 0px!important;">
...
<div class="modal fade" id="matchModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" onclick="javascript:window.location.reload()" class="btn btn-secondary"  data-dismiss="modal"><?php echo translate('close')?></button>
...
<div class="modal fade" id="staticBackdrop" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle"><?php echo translate('Expired');?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
          <p><?php echo translate('your_account_has_been_Expired');?></p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal"><?php echo translate('close')?></button>
        <a href="<?php echo base_url('app/Subscription');?>" class="btn btn-primary"><?php echo translate('membership_subscription')?></a>
