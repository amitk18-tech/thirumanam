...
<div class="tabs">
    <ul class="tab-links">
        <li class="active" style="width: 50%;"><a href="#tab1"> Accepted</a></li>
    ...
    <div class="tab-content">
        <div id="tab1" class="tab active">
          ...
          ?>
          <!-- Single News Post-->
          <div class="single-news-post d-flex align-items-center bg-gray mt-3">
            <div class="post-thumbnail image"><?php echo $image;?></div>
            <div class="post-content">
               
            <a class="post-title" style="font-size:15px;font-weight: 700"> <?php echo ((strlen($member->first_name)>50) ? substr($member->first_name,0,50).'..' : $member->first_name); ?></a>
        ...
        <div id="tab2" class="tab">
          ...
          <div class="row mb-2">
              <div class="col-4" style="width:100%;">
                   <a class="btn btn-success px-1" style="padding: 7px;border-radius: 8px;background: white;color:#f8587e;box-shadow: 0 2px 2px 0 rgba(16, 13, 209, 0.175);border: none;font-size: 14px;width:100%" href="<?php echo base_url('app/short_view/'.$member->member_id);?>">More Info</a>

              </div>
              <div class="col-4" style="width:100%;text-align: end;">
                   <a class="btn btn-success px-3 bg-danger text-white" style="padding: 7px;border-radius: 8px;background: white;box-shadow: 0 2px 2px 0 rgba(16, 13, 209, 0.175);border: none;font-size: 14px;width:100%" onclick="confirm_reject(<?=$member->member_id;?>)"><?php echo translate('reject')?></a>
              </div>
              <div class="col-4" style="width:100%;text-align: center;">
                   <a class="btn btn-success px-2 bg-success" style="border-radius: 8px;font-size: 14px;color:white;width:100%;border :1px solid #00b894" onclick="confirm_accept(<?php echo $member->member_id;?>)"><?php echo translate('accept')?></a>
              </div>
            </div>
          <!-- Single News Post-->
          <?php } } }?>
