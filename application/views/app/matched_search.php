...
<div class="page-content-wrapper">
  ...
  <div class="element-wrapper">
    ...
    <div class="container">
    <form action="<?php echo base_url('app/matched_member_list');?>" method="post">
...
<div class="banner__list">
    <div class="row align-items-center row-cols-1">
        ...
        <div class="col">
            ...
            <div class="banner__inputlist">
                <input class="form-control" type="text" name="member_id" id="filter_member_id" value="<?php echo (!empty($this->session->userdata('adv_search')['member_profile_id'])) ? $this->session->userdata('adv_search')['member_profile_id'] : '' ;?>">
            </div>
        </div>
        <div class="col">
        ...
        <div class="col">
            ...
            // print_r($marital_status1);exit;
               ?>
            <div class="banner__inputlist">
                <select class="form-control" name="star[]" id="filter_star">
                    <option value=""><?php echo translate('choose_one')?></option>
    ...
    <?php } ?>
        <div class="col">
            ...
            // print_r($marital_status1);exit;
               ?>
            <div class="banner__inputlist">
                <select class="form-control" name="father_vangusam[]" id="filter_Type_of_study">
                    <option value=""><?php echo translate('choose_one')?></option>
