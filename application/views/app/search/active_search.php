<div class="page-content-wrapper">
  ...
  <div class="element-wrapper">
         ...
         <div class="row">
            ...
            <div class="col-10">
               <div class="search-page-form mb-5">
                  <!-- Search via Voice-->
                  <form id="form1" action="<?php echo base_url('app/active_seach_list');?>" method="post">
            ...
            <div class="col-2">
               <div class="search-page-form bg-secondary text-center" style="border-radius: 10px;padding: 11px;padding-right: 36px;">
                  <a href="<?php echo base_url('app/active_member_search/active_search_all')?>">
      ...
      <div class="row">
         ...
         <a href="<?php echo base_url('app/active_member_search/appearance_search')?>">
         ...
         <div class="col-6" style="height:40%">
            <a href="<?php echo base_url('app/active_member_search/edupro_search')?>">
         ...
         <div class="col-6" style="height:40%">
            <a href="<?php echo base_url('app/active_member_search/family_search')?>">
         ...
         <div class="col-6" style="height:40%">
            <a href="<?php echo base_url('app/active_member_search/astrologic_search')?>">
