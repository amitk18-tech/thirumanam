...
<div class="tabs">
    <ul class="tab-links">
        ...
        <li><a href="#tab2" style="width: 50%;"> Sended Interests</a></li>
        ...
        <div id="tab2" class="tab">
          ...
          <!-- <div class="row p-2">
              <div class="col-6" style="width:100%;">
                   <a class="btn btn-success px-4" style="padding: 7px;border-radius: 8px;background: white;color:#f8587e;box-shadow: 0 2px 2px 0 rgba(16, 13, 209, 0.175);border: none;font-size: 14px" href="<?php echo base_url('app/short_view/'.$member->member_id);?>">More Info</a>
              </div>
              <div class="col-6" style="width:100%;">
                   <a class="btn btn-success px-4" style="border-radius: 8px;font-size: 14px;color:white" onclick="confirm_accept(<?php echo $member->member_id;?>)">Accept Request</a>
              </div>
            </div> -->
          <!-- Single News Post-->
          <?php } } }?>
