<style>
 .dot-falling {
  ...
  color: #f8587e;
  box-shadow: 9999px 0 0 0 #f8587e;
...
@keyframes dot-falling-before {
  ...
  25%, 50%, 75% {
    box-shadow: 9984px 0 0 0 #f8587e;
  }
  100% {
    box-shadow: 9984px 15px 0 0 rgba(152, 128, 255, 0);
  }
...
@keyframes dot-falling-after {
  ...
  25%, 50%, 75% {
    box-shadow: 10014px 0 0 0 #f8587e;
  }
  100% {
    box-shadow: 10014px 15px 0 0 rgba(152, 128, 255, 0);
  }
...
?>
    <div class="container mt-3" style="margin-top:60px !important;text-align: end;
    ">
      <p style="font-weight: bold;"><?php echo translate('members');?>: <span><?php echo $total_data;?></span></p>
    </div>
...
//         $.ajax({
//             type:'POST',
//             url: base_url+"WelcomeController/active_search_more/"+'?id='+ID,
//             data:$('#my_form').serialize(),
//             success:function(html){                
//                 // $('#member_id').val(parseInt(ID)-5);
    ...
    function onScroll(){
        ...
        if ($(window).scrollTop() >  $(document).height() - $(window).height() - 100 && (lastID != 0)) {
           ...
           // alert(lastID);
            $.ajax({
                type:'POST',
                url: base_url+"AppController/active_search_more/"+'?id='+lastID,
                data: $('#my_form').serialize(),
                beforeSend:function(){
                    $('.loding'+lastID).show();
                },
