...
<div class="container">
          ...
          <div class="row p-2">
              <div class="col-6" style="width:100%;">
                   <a class="btn btn-success" style="padding: 7px;border-radius: 8px;background: white;color:#f8587e;box-shadow: 0 2px 2px 0 rgba(16, 13, 209, 0.175);border: none;font-size: 14px;padding-left: 40px;padding-right: 40px;margin-top: 2px" href="<?php echo base_url('app/short_view/'.$member->member_id);?>">More Info</a>
              </div>
              <div class="col-6" style="text-align: end;">
                  <a class="btn btn-success" style="border-radius: 8px;font-size: 14px;color:white;padding-left: 40px;padding-right: 40px;margin-top: 2px" onclick="confirm_unblock(<?php echo $member->member_id;?>)" ><i class="fa fa-check"></i></a>
              </div>
