...
<div class="relative overflow-hidden" x-data="heroSlider()">
    ...
    <div class="relative max-w-7xl mx-auto px-4 py-40 sm:px-6 lg:px-8 text-center">
        <div class="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 text-white text-sm px-4 py-1.5 rounded-full mb-6">
            ...
            Trusted Tamil Matrimonial Platform
        </div>
        <h1 class="text-4xl md:text-6xl font-bold text-white mb-4 leading-tight">
            Find Your<br><span class="text-[#F24570]">Perfect Match</span>
        </h1>
        <p class="text-lg text-gray-300 mb-10 max-w-xl mx-auto">
            Connecting Tamil families across India and the world with trust, tradition and care.
        </p>
        ...
        <div class="flex flex-col sm:flex-row justify-center gap-4">
            <a href="{{ url('/members') }}" class="bg-[#F24570] text-white font-semibold px-8 py-3.5 rounded-full hover:bg-[#d63560] transition shadow-lg shadow-pink-900/30">
                <i class="fas fa-search mr-2"></i>Browse Members
            </a>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            ...
            <div class="group">
                ...
                <div class="text-gray-500 text-sm">Online Members</div>
            </div>
            <div class="group">
                <div class="text-4xl font-bold text-[#8B1A1A] mb-1 group-hover:text-[#F24570] transition">1500+</div>
                <div class="text-gray-500 text-sm">Male Profiles</div>
            </div>
            <div class="group">
                <div class="text-4xl font-bold text-[#8B1A1A] mb-1 group-hover:text-[#F24570] transition">1500+</div>
                <div class="text-gray-500 text-sm">Female Profiles</div>
            </div>
        </div>
    </div>
</div>
...
@if($isLoggedIn && !empty($members))
<div class="py-16 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-10">
            <h2 class="text-2xl font-bold text-gray-800">Featured Members</h2>
            <p class="text-gray-500 mt-2 text-sm">Verified profiles looking for their perfect match</p>
        </div>
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
            ...
            <a href="{{ url('/members/' . ($member['id'] ?? '')) }}"
                ...
                <div class="aspect-square overflow-hidden bg-gray-100 relative">
                    ...
                    @else
                        <div class="w-full h-full flex items-center justify-center bg-red-50 text-[#8B1A1A]/30">
                            <i class="fas fa-user text-5xl"></i>
                        </div>
                    @endif
                </div>
                <div class="p-3">
                    <div class="font-semibold text-gray-800 text-sm truncate">{{ $member['name'] ?? 'Member' }}</div>
                    @if(!empty($member['profile_marital_status']))
                        <div class="text-xs text-gray-400 mt-0.5 capitalize">{{ str_replace('_', ' ', $member['profile_marital_status']) }}</div>
                    @endif
                </div>
            </a>
            @endforeach
...
<div class="py-16 bg-gray-50">
    <div class="max-w-4xl mx-auto px-4">
        <div class="bg-gradient-to-br from-[#8B1A1A] to-[#F24570] rounded-3xl p-10 text-center text-white shadow-xl">
            ...
            <h2 class="text-3xl font-bold mb-3">Begin Your Journey</h2>
            <p class="text-red-100 mb-8 max-w-md mx-auto">Join thousands of Tamil families who found their perfect match on Thirumanam. Free registration, verified profiles.</p>
            <div class="flex flex-col sm:flex-row justify-center gap-4">
...
<div class="py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            ...
            <p class="text-gray-500 mt-2 text-sm">Simple steps to find your life partner</p>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div class="bg-gray-50 rounded-2xl p-8 border border-gray-100 hover:shadow-md transition">
                ...
                <p class="text-gray-500 text-sm">Create your profile with personal, family and horoscope details.</p>
            </div>
            <div class="bg-gray-50 rounded-2xl p-8 border border-gray-100 hover:shadow-md transition">
                <div class="w-16 h-16 bg-[#8B1A1A]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <h3 class="font-bold text-gray-800 mb-2">Search</h3>
                <p class="text-gray-500 text-sm">Browse and filter verified profiles matching your preferences.</p>
            </div>
            <div class="bg-gray-50 rounded-2xl p-8 border border-gray-100 hover:shadow-md transition">
                <div class="w-16 h-16 bg-[#8B1A1A]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <p class="text-gray-500 text-sm">Send interest, shortlist profiles and start your journey together.</p>
            </div>
        </div>
    </div>
</div>
...
<div class="py-16 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            <h2 class="text-2xl font-bold text-gray-800">Why Choose Thirumanam?</h2>
            <p class="text-gray-500 mt-2 text-sm">Trusted by thousands of Tamil families</p>
        </div>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="bg-white rounded-2xl p-6 border border-gray-100 hover:shadow-md transition text-center">
                ...
                <h4 class="font-semibold text-gray-800 mb-2">Verified Profiles</h4>
                <p class="text-gray-500 text-xs">Every profile is manually reviewed by our team before activation.</p>
            </div>
            <div class="bg-white rounded-2xl p-6 border border-gray-100 hover:shadow-md transition text-center">
                ...
                <h4 class="font-semibold text-gray-800 mb-2">Privacy First</h4>
                <p class="text-gray-500 text-xs">Your contact details are only shared with your approved matches.</p>
            </div>
            <div class="bg-white rounded-2xl p-6 border border-gray-100 hover:shadow-md transition text-center">
                ...
                <h4 class="font-semibold text-gray-800 mb-2">Tamil Focused</h4>
                <p class="text-gray-500 text-xs">Built specifically for Tamil community with horoscope matching support.</p>
            </div>
            <div class="bg-white rounded-2xl p-6 border border-gray-100 hover:shadow-md transition text-center">
                <div class="w-12 h-12 bg-red-50 rounded-full flex items-center justify-center mx-auto mb-4">
                    <i class="fas fa-headset text-[#8B1A1A] text-lg"></i>
                </div>
                <h4 class="font-semibold text-gray-800 mb-2">Dedicated Support</h4>
                <p class="text-gray-500 text-xs">Our team is available to assist you at every step of your journey.</p>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row items-center justify-between gap-10">
            <div class="text-white text-center md:text-left">
                <h2 class="text-3xl font-bold mb-2">Find Your Match On The Go</h2>
                <p class="text-red-200 mb-8 max-w-md">Download the Thirumanam app and stay connected with your matches anytime, anywhere.</p>
            ...
            <div class="flex gap-8 text-center text-white">
                <div>
                    ...
                    <div class="text-red-200 text-sm mt-1">App Downloads</div>
                </div>
                <div class="w-px bg-white/20"></div>
                <div>
                    <div class="text-4xl font-bold text-[#F24570]">4.8★</div>
                    <div class="text-red-200 text-sm mt-1">User Rating</div>
                </div>
                <div class="w-px bg-white/20"></div>
                <div>
                    <div class="text-4xl font-bold text-[#F24570]">500+</div>
                    <div class="text-red-200 text-sm mt-1">Matches Made</div>
                </div>
            </div>
        </div>
    </div>
...
<div class="py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-10">
            ...
            <p class="text-gray-500 mt-2 text-sm">We are here to help you every step of the way</p>
        </div>
